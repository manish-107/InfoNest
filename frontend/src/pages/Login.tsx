  ...
  return (
    <div className="flex items-center min-h-screen px-4 py-8">
                    <div className="relative w-full max-w-md p-6 mx-auto bg-white rounded-md shadow-lg">
                      <h2 className="mb-4 text-2xl font-semibold text-center text-gray-800">Welcome back!</h2>
                      <form>
                        <div className="mb-4">
                          <label className="block mb-2 text-sm font-bold text-gray-700">Email Address</label>
                          <input
                            className="block w-full px-4 py-2 bg-white border rounded-md focus:border-blue-500 focus:outline-none focus:ring"
                            type="email"
                            required
                          />
                        </div>
                        ...
                        <div className="text-center">
                          ...
                          <Link to="/signup" className="ml-2 text-sm text-blue-500 hover:underline">
                            Sign Up
                          </Link>
                        </div>
                      </form>
