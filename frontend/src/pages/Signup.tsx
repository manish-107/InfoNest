    ...
    return (
      ...
      <div className="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
        <div className="flex flex-col justify-center min-h-full px-4 py-4 space-y-16 max-md:order-1 max-md:mt-16 bg-gradient-to-r from-gray-900 to-gray-700 lg:px-8">
          ...
          <div>
            <h4 className="text-lg font-semibold text-white">Simple & Secure Registration</h4>
        ...
        <form className="w-full px-6 py-6 md:col-span-2 sm:px-16">
          <div className="mb-6">
            <h3 className="text-2xl font-bold">Create an account</h3>
          </div>
          <div className="space-y-5 font-semibold">
            <div>
              <label className="block mb-2 text-sm text-start">Username</label>
              <div className="relative flex items-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="absolute w-4 h-4 right-4" viewBox="0 0 24 24">
            ...
            <div>
              <label className="block mb-2 text-sm text-start">Email Id</label>
              <div className="relative flex items-center">
            ...
            <div>
              <label className="block mb-2 text-sm text-start">Password</label>
              <div className="relative flex items-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="absolute w-4 h-4 cursor-pointer right-4" viewBox="0 0 128 128">
          ...
          <div className="!mt-10">
            <button type="button" className="w-full px-4 py-3 text-sm font-semibold text-white bg-gray-700 rounded hover:bg-gray-800 focus:outline-none">
              Create an account
            </button>
          </div>
          <p className="mt-6 text-sm text-center">Already have an account?<Link className="ml-1 font-semibold text-blue-600 hover:underline" to="/signin"> Sign In</Link></p>
        </form>
      </div>
    </div>
      </>
